...
function App() {
  ...
  Mousetrap.bind(['command+1'], function () { window.location = '/dashboard'; });
  Mousetrap.bind(['command+2'], function () { window.location = '/projects'; });
  Mousetrap.bind(['command+3'], function () { window.location = '/monitors'; });
  Mousetrap.bind(['command+4'], function () { window.location = '/names'; });
  Mousetrap.bind(['command+5'], function () { window.location = '/signatures'; });
  Mousetrap.bind(['command+6'], function () { window.location = '/settings/skins'; });
  Mousetrap.bind(['command+7'], function () { window.location = '/support/keys'; });
  Mousetrap.bind(['command+8'], function () { window.location = '/support/free'; });
  Mousetrap.bind(['q l'], function () { panelDispatch({ type: 'collapse' }) });
  Mousetrap.bind(['q a'], function () { panelDispatch({ type: 'expand' }) });
  Mousetrap.bind(['q h'], function () { panelDispatch({ type: 'help' }) });
  Mousetrap.bind(['q m'], function () { panelDispatch({ type: 'menu' }) });
  Mousetrap.bind(['q c'], function () { panelDispatch({ type: 'content' }) });
  Mousetrap.bind(['q s'], function () { panelDispatch({ type: 'status' }) });
