...
//    var response = await fetch(`${process.env.REACT_APP_API_URL}/transactions?transactions=${txID}`, { mode: 'cors' });
    var response = await fetch(`http://localhost:8080/transactions?transactions=${txID}`, { mode: 'cors' });
