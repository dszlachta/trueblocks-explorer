...
export const DataTable = memo(
  ({
    ...
    const [
      { rowsPerPage, currentPage, selectedRows, allSelected, selectedCount, sortColumn, selectedColumn, sortDirection },
      dispatch,
      ...
      <ThemeProvider theme={currentTheme}>
        <DataTableProvider initialState={init}>
          <ResponsiveWrapper
            ...
            overflowY={overflowY}
          >
            {!noHeader && <TableHeader title={title} actions={actions} showMenu={!noContextMenu} />}
            ...
            <TableWrapper>
              ...
              {paginateAtTop && enabledPagination && (
                <Pagination
              ...
              <Table disabled={disabled} className="rdt_Table" role="table">
                ...
                {!data.length > 0 && !progressPending && <NoData>{noDataComponent}</NoData>}
