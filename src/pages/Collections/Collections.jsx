...
export const Collections = () => {
  ...
  return (
    <div>
      <PageCaddie caddieName="Tags" caddieData={tagList} current={curTag} handler={collectionsHandler} loading={loading} />
      <DataTable
      ...
      />
      <Modal showing={editor.showing} handler={collectionsHandler}>
        {/* prettier-ignore */}
        <ObjectTable
            data={editor.record}
            columns={collectionsSchema}
